...
<!--
  Copyright (C) 2020 - present Gruppe 2, Hochschule Karlsruhe
...
- [Hinweise zum Programmierbeispiel](#hinweise-zum-programmierbeispiel)
  ...
  - [Relationale Datenbanksysteme](#relationale-datenbanksysteme)
    - [PostgreSQL](#postgresql)
      - [Docker Compose für PostgreSQL und pgadmin](#docker-compose-für-postgresql-und-pgadmin)
      - [Skaffold für PostgreSQL und pgadmin](#skaffold-für-postgresql-und-pgadmin)
      - [helmfile für PostgreSQL und pgadmin](#helmfile-für-postgresql-und-pgadmin)
    - [MySQL](#mysql)
      - [Docker Compose für MySQL und phpMyAdmin](#docker-compose-für-mysql-und-phpmyadmin)
      - [Skaffold für MySQL und phpMyAdmin](#skaffold-für-mysql-und-phpmyadmin)
      - [helmfile für MySQL und phpMyAdmin](#helmfile-für-mysql-und-phpmyadmin)
...
```powershell
    docker compose exec postgres sh
       psql --dbname=postgres --username=postgres --file=/sql/create-db-computer.sql
```
